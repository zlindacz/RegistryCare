...
class Home extends React.Component {
  ...
  render() {
    return (
      <div className="home">
        <div className="row">
          <section className="home-quote-block col-12">
        ...
        <section className="home-content-block">
          <div className="home-testimonials">
            <div className="home-user row">
              <div className="quote col-4 offset-left-2">
              ...
              <div className="home-testimonial-photo col-4 offset-right-2">
            ...
            <div className="home-org row">
              <div className="home-testimonial-photo col-4 offset-left-2">
              ...
              <div className="quote col-4 offset-right-2">
